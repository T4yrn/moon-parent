...
import dev.t4yrn.moon.bukkit.command.annotation.Classifier;
import dev.t4yrn.moon.bukkit.command.annotation.Modifier;
...
public class ModifierService {
    ...
    public ModifierService(CommandService commandService) {
    ...
    public Object executeModifiers(@Nonnull CommandExecution execution, @Nonnull CommandParameter param, @Nullable Object parsedArgument) throws CommandExitMessage {
        ...
        for (Annotation annotation : param.getModifierAnnotations()) {
            ...
            if (container != null) {
                for (CommandModifier modifier : Objects.requireNonNull(container.getModifiersFor(param.getType()))) {
